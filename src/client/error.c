...
const char *cubicle_error_code_name(cubicle_error_code_t code)
{
    ...
    case CUBICLE_ERR_AUTHENTICATION_FAILED: return "authentication_failed";
    case CUBICLE_ERR_SESSION_EXPIRED: return "session_expired";
    case CUBICLE_ERR_UNSUPPORTED: return "unsupported";
    case CUBICLE_ERR_INVALID_STATE: return "invalid_state";
    case CUBICLE_ERR_CONFLICT: return "conflict";
    ...
    case CUBICLE_ERR_RESOURCE_LIMIT: return "resource_limit";
