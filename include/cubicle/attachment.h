...
cubicle_error_code_t cubicle_attachment_connect_relay(cubicle_client_t *manager, const cubicle_attachment_grant_t *grant, const cubicle_attachment_options_t *options, cubicle_attachment_t **attachment_out);
